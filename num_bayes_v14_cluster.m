...
for expt = 1:2
    ...
    if expt == 1
        str(1).name = 'dr-spot1.sdt';
        str(2).name = 'dr-spot2.sdt';
        str(3).name = 'dr-spot3.sdt';
        
        str(4).name = 'm0-e1-s2-spot1.sdt';
        str(5).name = 'm0-e1-s2-spot2.sdt';
        str(6).name = 'm0-e1-s2-spot3.sdt';
        
        str(7).name = 'm0-e1-s3-spot1.sdt';
        str(8).name = 'm0-e1-s3-spot2.sdt';
        str(9).name = 'm0-e1-s3-spot3.sdt';
        
        irfname = 'irf-137.sdt';
        data_shift_name = 'dr-spot3.sdt';
        
        
    else
        str(1).name = 'dt-spot1.sdt';
        str(2).name = 'dt-spot2.sdt';
        str(3).name = 'dt-spot3.sdt';
    ...
    for index = 1:3
        ...
        pth_irf = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-4-8\'; %Type the file path of the Instrument Response Function (IRF) here.
        ...
        pth_data_for_shift = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-4-8\';
        ...
        %%
        pth_data = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-4-8\';
        ...
        for l1 = 1:2
            ...
            if l1 == 1
                w1step = .01; w1min= .5; w1max = .5; %w1min must be an integer multiple of w1step.
                w2step = .01; w2min = 3.7; w2max = 4.3;
                fracstep = 0.005;
        ...
        prBestmat(expt,index) = prBest;
        w2Bestmat(expt,index) = w2Best;
        w1Bestmat(expt,index) = w1Best;
