...
%                 end
                str(1).name = 'm3-e1-s1-spot1.sdt';
                str(2).name = 'm3-e1-s1-spot2.sdt';
                str(3).name = 'm3-e1-s1-spot3.sdt';
                
                str(4).name = 'm3-e1-s2-spot1.sdt';
                str(5).name = 'm3-e1-s2-spot2.sdt';
                str(6).name = 'm3-e1-s2-spot3.sdt';
                
                str(7).name = 'm3-e1-s3-spot1.sdt';                
                str(8).name = 'm3-e1-s3-spot2.sdt';
                str(9).name = 'm3-e1-s3-spot3.sdt';
                
            end
            irfname = 'irf-541pm.sdt';
            ...
            for cindex = 1:cyclesmax
                ...
                pth_irf = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-2-27\'; %Type the file path of the Instrument Response Function (IRF) here.
                ...
                pth_data_for_shift = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-2-27\';
                %data_shift_name = 'm0-e1-s1-spot1.sdt';
                ...
                w1step = .005; w1min= .8; w1max = 2.2; %.8-2 1.05 %w1min must be an integer multiple of w1step.
                w2step = .005; w2min =  3.745; w2max =  3.745; %3.81
                
                fracstep = 0.002;%.002
                prstep = fracstep; prmin=0; prmax = .5;
                ...
                pth_data = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-2-27\';
