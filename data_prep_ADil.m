...
for el = 1:1
    ...
    comment = 'find pr vs m3-0 Ran w1=1.64 thresh = 500k';
    tfw = 0.6;
    tbac = 0.2;
        ...
        for expt = 1:exptmax
            if expt == 1
                ...
                for cycle = 0:cyclesmax-1;
                    sn = 3 - floor((cycle)/spc);
                    str(cycle+1).name = strcat('m',num2str(sn),'n-spot',num2str(mod(cycle,spc)+1),'.sdt');
                end
                
%                 for cycle = 0:cyclesmax-1;
%                     str(cycle+1).name = strcat('m5-e1-spot',num2str(cycle+1),'.sdt');
%                 end
%                 str(1).name = 'te2-spot1.sdt';
%                 str(2).name = 'te2-spot2.sdt';
%                 str(3).name = 'te2-spot3.sdt';
%                 str(4).name = 'te2-spot4.sdt';
%                 str(5).name = 'te2-spot5.sdt';
%                 
%                 str(6).name =  'te2-spot6.sdt';
%                 str(7).name =  'te2-spot7.sdt';
%                 str(8).name =  'te2-spot8.sdt';
%                 str(9).name =  'te2-spot9.sdt';
%                 str(10).name = 'te2-spot10.sdt';
...
%                 str(12).name = 'm0-spot7.sdt';
            ...
            for cindex = 1:cyclesmax
                ...
                w1step = .005; w1min= 1.64; w1max = 1.64; %.8-2 1.05 %w1min must be an integer multiple of w1step.
                w2step = .005; w2min =  3.82; w2max =  3.82; %3.87 for 0.6ns removed
                
                fracstep = 0.002;%.002
                prstep = fracstep; prmin=0; prmax = 0.5;
