...
for el = 1:1
    ...
    comment = 'T1-m2 w2=3.745 w1=1.35:.05:1.55 mout1396-1400';
    tfw = .6;
    tbac = .2;
    ...
    for jind = 1:jmax
        for expt = 1:exptmax
            ...
            for cindex = 1:cyclesmax
                ...
                irfname = 'irf-254pm-11m.sdt';
                data_shift_name = 'coum_5e5_0pc.sdt';
                
                
                if cindex <10
                    str(cindex).name = strcat('t3-m2_c0',num2str(cindex),'.sdt');
                else
                    str(cindex).name = strcat('t3-m2_c',num2str(cindex),'.sdt');
                end
                ...
                pth_irf = 'Z:\bkaye\Bayes_2013\data\2013-10-11\';
                %pth_irf = 'C:\Users\Bryan\Documents\MATLAB\Bayes_2014\data\2014-8-27\'; %Type the file path of the Instrument Response Function (IRF) here.
                %irfname = 'irf-641pm.sdt';

                pth_wigs = 'Z:\bkaye\Bayes_2013\data\2013-10-11\';
                wigsname = 'wigs-316pm-120m.sdt';
...
%                 wigsname = 'wigs-overhead-5e5.sdt';
                ...
                w1step = .005; w1min= 1.3 + el*.05; w1max =w1min; %.8-2 1.05 %w1min must be an integer multiple of w1step.
                w2step = .005; w2min =  3.745; w2max =  3.745;% 3.745 for tfw=.6 on 8/27/14 extract %3.81
                ...
                %                                 if cindex ==6
                %                                 input(cindex,expt,jind).datahis = p2;
                %                                 else
    ...
    fprintf('DN is: %s and w1 is %1.3f and w2 is %1.3f\n',dataname,w1min,w2min);
